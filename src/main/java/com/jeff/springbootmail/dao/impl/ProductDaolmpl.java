package com.jeff.springbootmail.dao.impl;
...
import com.jeff.springbootmail.rowmapper.ProductRowMapper;
...
public class ProductDaolmpl implements ProductDao {
    ...
    public Integer countProduct(ProductQueryParams productQueryParams) {
        ...
        //查詢條件
       sql = addFilerngSql(sql,map,productQueryParams);
    ...
    public Integer createProduct(ProductRequest productRequest) {
        String sql = "INSERT INTO product(product_name,category,image_url,price,stock,description, " +
                "created_date,last_modified_date VALUES(:productName, :category, :imageUrl,:price,:stock,:description," +
    ...
    private String addFilerngSql(String sql,Map<String,Object>map,ProductQueryParams productQueryParams){
